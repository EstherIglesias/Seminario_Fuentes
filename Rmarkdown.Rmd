...
En este trabajo hemos decido buscar la relación que creemos que existe y relaciona
el paro con una mala alimentación. Para poder realizarlo hemos comenzando buscando
información previa en la que hayan sido previamente relacionados. Al no encontrar
información que lo vínvule hemos decido buscar datos de paro y alimentación y 
crear nuestra propia relación.

# Objetivos 
El objetivo principal es saber si existe una relación entre el paro y la alimentación.
Además, también quisimos saber si los datos de paro variaban en relación al sexo de
las personas o si este era similar. Por último, queríamos saber si existía una 
relación entre el paro y la edad y el sexo de las personas implicadas.

# Carga de paquetes/métodos(nsq poner)

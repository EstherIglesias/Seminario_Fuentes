...
En este trabajo vamos a ver existe una relación entre 
...
Vemos que si se ha relacionado el desempleo con unos empeoramientos de la dieta y de los cuidados básicos de la salud. También encontramos información entre alimentación y empleo, que son dos conceptos que se retroalimentan. Por tanto vemos que las personas en paro tienen mayor riesgo de padecer una peor salud (física y mental) y una mayor alimentación basada en 'comida basura' y ultraprocesados. 
Si hemos encontrado algo de información pero hemos decido buscar datos de paro y alimentación y crear nuestra propia relación.
